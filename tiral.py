...
def add_speed_to_player1(score2,fall_speed1):
    fall_speed1 += 50000
    print("player 1 Speed: " + str(fall_speed1))

def add_speed_to_player2(score1,fall_speed2):
    fall_speed2 += score1
    print("player 2 Speed: " + str(fall_speed2))
...
def clear_rows(grid, opponent_grid):
    ...
    if cleared_rows > 0:
        add_speed_to_player1(score2,fall_speed1)
        add_speed_to_player2(score1,fall_speed2)
